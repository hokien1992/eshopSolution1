...
{
    public partial class AspNetCoreIdentityDatabase1 : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    OrderDate = table.Column<DateTime>(nullable: false, defaultValue: new DateTime(2020, 11, 26, 16, 9, 16, 956, DateTimeKind.Local).AddTicks(8948)),
                    UserId = table.Column<Guid>(nullable: false),
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, new DateTime(2020, 11, 26, 16, 9, 16, 979, DateTimeKind.Local).AddTicks(4666), 100000m, 200000m, null });
